...
def article_overview(kind, period):
    ...
    for i in range(len(data)):
        ...
        #print "Media len is " + str(len(media))
		#pprint.pprint(media)
        ...
        for i in range(len(media)):
            for j in range(len(media[i]['media-metadata'])):
                if media[i]['media-metadata'][j]['format'] == 'Standard Thumbnail':
                    ul = media[i]['media-metadata'][j]['url']
                    urls.append(ul)
                    #print "appending " + ul
		#print "----"
    print "Len of titles is " + str(len(titles))
    print "len of url is " + str(len(urls))
    return (titles, urls)
